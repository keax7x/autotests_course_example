...
def letter_stat(our_str):
    """
    функция преобразует строку в словарь, ключами словаря являются буквы этой строки,
    а значением - число, полученное как кол-во повторений буквы в строке
    :param our_str: строка с исходными данными
    :return: letter_dict: результат выполнения функции в виде словаря
    """
    letters_dict = {s: our_str.count(s) for s in our_str}
    return letters_dict
