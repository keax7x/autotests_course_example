...
def letter_stat(our_str):
    """
    функция преобразует строку в словарь, ключами словаря подставляются буквы этой строки,
    а значение - это число, полученное как кол-во повторений буквы в строке
    :param our_str: строка с исходными данными
    :return: letter_dict результат выполнения функции
    """
