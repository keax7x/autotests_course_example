...
def create_phone_number(num_tuple):
    b = ''.join(str(num_tuple))  # преобразовали кортеж в строку и объявили это в переменной b
    b = b.replace(', ', '')  # удалили из строки  запятую и пробел между цифрами
    str_phone = f'{b[0:4]}{b[-1]} {b[4:7]}-{b[-5:-1]}'
    return str_phone
